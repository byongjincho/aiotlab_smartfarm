...
public class LinechartSensor9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        yData.add(new Entry(0,343));
        yData.add(new Entry(1,232));
        yData.add(new Entry(2,423));
        yData.add(new Entry(3,123));
        yData.add(new Entry(4,232));
        yData.add(new Entry(5,543));
        yData.add(new Entry(6,442));

        LineDataSet set1 = new LineDataSet(yData,"센서9");
