...
public class Linechart_Humidity_Hour extends Fragment implements View.OnClickListener {
    ...
    public static Linechart_Humidity_Hour newInstance() {
        Linechart_Humidity_Hour f = new Linechart_Humidity_Hour();
        return f;
    }
...
// TextView 일자 변경
    ...
    private void showLineChartData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                humidRef = mDatabase.getReference("MQTT_Humidity_hour_" + yearString + monthString + dayString);
