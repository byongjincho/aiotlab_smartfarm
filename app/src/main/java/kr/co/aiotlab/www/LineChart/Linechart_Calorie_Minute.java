...
public class Linechart_Calorie_Minute extends Fragment implements View.OnClickListener {
    ...
    public static Linechart_Calorie_Minute newInstance() {
        Linechart_Calorie_Minute f = new Linechart_Calorie_Minute();
        return f;
    }
...
// TextView 일자 변경
            ...
            case R.id.txt_nextChart:
                ...
                if (Integer.parseInt(dayString) > 31) {
...
// TextView 일자 변경
    ...
    private void showLineChartData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                calorieRef = mDatabase.getReference("MQTT_Calorie_minute_" + yearString + monthString + dayString);
