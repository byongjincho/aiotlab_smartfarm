...
public class
Linechart_Temperature_Hour extends Fragment implements View.OnClickListener {
    ...
    public static Linechart_Temperature_Hour newInstance() {
        Linechart_Temperature_Hour f = new Linechart_Temperature_Hour();
        return f;
    }
...
// TextView 일자 변경
    ...
    private void showLineChartData() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                temp1Ref = mDatabase.getReference("MQTT_Temperature_hour_" + yearString + monthString + dayString);
