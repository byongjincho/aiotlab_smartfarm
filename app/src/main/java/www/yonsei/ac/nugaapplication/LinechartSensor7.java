...
public class LinechartSensor7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        yData.add(new Entry(0,112));
        yData.add(new Entry(1,132));
        yData.add(new Entry(2,231));
        yData.add(new Entry(3,134));
        yData.add(new Entry(4,161));
        yData.add(new Entry(5,71));
        yData.add(new Entry(6,323));

        LineDataSet set1 = new LineDataSet(yData,"센서7");
