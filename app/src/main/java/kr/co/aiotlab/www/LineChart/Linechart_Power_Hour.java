...
public class Linechart_Power_Hour extends Fragment implements View.OnClickListener {
    ...
    public static Linechart_Power_Hour newInstance() {
        Linechart_Power_Hour f = new Linechart_Power_Hour();
        return f;
    }
...
// TextView 일자 변경
    ...
    private void showLineChartData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                current1Ref = mDatabase.getReference("Current_hour_" + yearString + monthString + dayString);
