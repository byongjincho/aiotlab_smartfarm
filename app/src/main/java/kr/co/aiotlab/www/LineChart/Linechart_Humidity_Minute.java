...
public class Linechart_Humidity_Minute extends Fragment implements View.OnClickListener {
    ...
    public static Linechart_Humidity_Minute newInstance() {
        Linechart_Humidity_Minute f = new Linechart_Humidity_Minute();
        return f;
    }
...
// TextView 일자 변경
    ...
    private void showLineChartData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                humidRef = mDatabase.getReference("MQTT_Humidity_minute_" + yearString + monthString + dayString);
